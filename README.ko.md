...
**테스트 2791개 전부 통과**, 그리고 그 스위트가 실제로 실패할 수 있음을 증명하는
77종 뮤테이션 하네스. 둘 다 [검증](#검증)의 명령으로 재현한다.

**RFC 36편 — 32편 `Accepted`, RFC-0000은 RFC-0007로 `Superseded`, RFC-0033/0034/0035는 `Draft`.** RFC-0007은
