...
**47 RFCs — 45 `Accepted`, RFC-0000 `Superseded` by RFC-0007, RFC-0034 `Draft`.** RFC-0007 was formally
...
Forty-five are `Accepted`, one (`0034`) is `Draft`; 0000 is superseded by 0007, which was itself formally
