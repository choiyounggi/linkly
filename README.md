...
**42 RFCs — 39 `Accepted`, RFC-0000 `Superseded` by RFC-0007, RFC-0033/0034 `Draft`.** RFC-0007 was formally
...
Thirty-eight are `Accepted`, two (`0033`, `0034`) are `Draft`; 0000 is superseded by 0007, which was itself formally
