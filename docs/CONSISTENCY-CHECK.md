...
| C항목 | 기준 | 2026-07-31 판정 | 2026-08-03 재확인 | 근거 |
|-------|------|-----------------|------------------|------|
...
| **C5** | 골든 관통(C5a/C5b) | PASS | PASS | 소스·IR·런타임·컴파일러·KB·에이전트 6 요소 검증 완료(1309행 표), 골든 기계 생성으로 회귀 보호 |
...
| **C8** | Heap 프리미티브 계약 | **해소** (2026-07-31) | **해소 유지** | `:1328` `transfer` 프리미티브 신설됨, 이후 변경 0 |
| **C9** | 하네스 미탐지 3부류 | **해소** (2026-07-31) | **해소 유지** | `:1329` 동등성 목록 정정됨, 이후 변경 0 |
